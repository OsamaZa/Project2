...
class NN:
    ...
    def train(self):
        ...
        for i in range(self.epochs):
            ...
            self.cost.append(-np.mean(self.Y_data*np.log(self.probabilities) +(1-self.Y_data)*np.log(1-self.probabilities)))
        plt.figure()
...
learningrates = np.logspace(-10, -4, 5)
lmbds = np.logspace(-8, -2, 5)
